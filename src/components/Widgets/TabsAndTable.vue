		...
		<v-tabs v-model="active" slider-color="red" show-arrows>
			...
			<v-card flat v-if="n==1">
				<div class="table-responsive">
					<v-data-table
						:headers="headersForTransactionList" :items="tabsAndTableDetails.transactionListDetails" 
						hide-default-footer 
						align='center'
						>
			...
			<v-card flat v-if="n==2">
				...
				<div class="table-responsive">
					<v-data-table
						:headers="headersForExpenseCategory" :items="tabsAndTableDetails.expenseCategoryDetails"
						align='center'
						hide-default-footer
						>
						 <template v-slot:item.typeColor="{ item }">
...
<script>
import { tabsAndTableDetails } from 'Assets/data/tabsAndTableDetails.js'
